...
public class PostulacionController {
    ...
    public ResponseEntity<?> crearPostulacion(
        ...
        try {
            ...
            postulacion.setTrabajadorId(usuario.getUserId()); // Usar UUID del usuario
    ...
    public ResponseEntity<?> actualizarEstado(
        ...
        String idEmpleador = jwt.getSubject(); 

        try {
            Postulacion p = postulacionService.gestionarPostulacion(ofertaId, trabajadorId, nuevoEstado, idEmpleador);
